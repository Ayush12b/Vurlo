...
async function run() {
  console.log("Starting dual-naming system SEO database migration...");
  ...
  for (const docSnap of snap.docs) {
    ...
    if (seoUpdatesV3[slug]) {
      const updateData = seoUpdatesV3[slug];
      console.log(`\nProduct slug: "${slug}"`);
      console.log(`  Updating name/displayName to: "${updateData.displayName}"`);
      console.log(`  Updating seoTitle to: "${updateData.seoTitle.substring(0, 45)}..."`);
