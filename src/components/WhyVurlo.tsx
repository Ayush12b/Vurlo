...
const features = [
  {
    ...
    desc: "Aerospace-grade materials and rigorous QA on every unit shipped.",
  },
  {
    icon: Truck,
    title: "Fast Delivery",
    desc: "Carbon-neutral 48-hour shipping to your door, worldwide.",
  },
  {
    icon: Rocket,
    title: "Future-Ready",
    desc: "Modular, upgradable hardware built to evolve with tomorrow.",
  },
];
